...
public class LucenePDFDocument {
    ...
    public Document convertDocument(File file) throws IOException {
        ...
        try {
            ...
            addContent(document, input, file.getAbsolutePath());
        } finally {
            if (input != null) {
                input.close();
            }
...
//            System.exit( 1 );
//        }
        System.out.println("Document=" + getDocument(new File("E:/download/IKAnalyzer中文分词器V3.2.8使用手册.pdf")));
    }
}
