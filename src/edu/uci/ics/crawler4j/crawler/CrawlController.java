 ...
 * 控制爬虫，先addseed，再开启多个爬虫，并不断监听各个爬虫存活状态
 */
public class CrawlController extends Configurable {
	...
	protected PageFetcher pageFetcher;//启动IdleConnectionMonitorThread，用fetch(Page, ignoreIfBinary)，爬取单个Page页面。是一个static类。
	protected RobotstxtServer robotstxtServer;//用来判断url是否被允许
